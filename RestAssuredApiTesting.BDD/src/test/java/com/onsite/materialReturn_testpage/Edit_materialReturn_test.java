...
public class Edit_materialReturn_test extends BaseToken{
	...
	public Object[][] getData() throws IOException{
		...
		materialReturnPayload = mapper.readValue(
	...
	public void getMaterialReturnEdit(MaterialReturnRequest payload) {
	...
	@Test(priority=2, dependsOnMethods="getMaterialReturnEdit")
	public void validStatusCode() {

		int responseStatusCode = editMaterialReturnResponse.getStatusCode();
	...
	@Test(priority=3, dependsOnMethods="getMaterialReturnEdit")
	public void validResponseTime() {

		Assert.assertEquals(editMaterialReturnResponse.getStatusCode(), 200, "Expected Status Code: 200 but found: " + editMaterialReturnResponse.getStatusCode());

		long responseTime = editMaterialReturnResponse.getTime();
		System.out.println("response time :" + responseTime + "ms");

		Assert.assertTrue(responseTime < 2000, "Response time is too long :" + responseTime + "ms");
	}

	@Test(priority=4, dependsOnMethods="getMaterialReturnEdit")
	public void validResponseSchema() {

		Assert.assertEquals(editMaterialReturnResponse.getStatusCode(), 200, "Expected Status Code: 200 but found: " + editMaterialReturnResponse.getStatusCode());

		editMaterialReturnResponse.then().assertThat().body(JsonSchemaValidator.matchesJsonSchemaInClasspath(
				"responseSchema_files/MaterialReturnResponse_schema.json"));
	}

	@Test(priority=5, dependsOnMethods="getMaterialReturnEdit")
	public void validMaterialReturnId() throws IOException {

		Assert.assertEquals(editMaterialReturnResponse.getStatusCode(), 200, "Expected Status Code: 200 but found: " + editMaterialReturnResponse.getStatusCode());

		String materialReturnId = editMaterialReturnResponse.jsonPath().getString("id");
	...
	@Test(priority=6, dependsOnMethods="getMaterialReturnEdit")
	public void validCompanyId() {
		...
		String companyId = editMaterialReturnResponse.jsonPath().getString("company_id");
	...
	@Test(priority=7, dependsOnMethods="getMaterialReturnEdit")
	public void validRemark() {

		Assert.assertEquals(editMaterialReturnResponse.getStatusCode(), 200, "Expected Status Code: 200 but found: " + editMaterialReturnResponse.getStatusCode());

		String resRemark = editMaterialReturnResponse.jsonPath().getString("remark");
	...
	@Test(priority=8, dependsOnMethods="getMaterialReturnEdit")
	public void validPartyCompanyUserId() {

		String resPartyCompanyUserId = editMaterialReturnResponse.jsonPath().getString("party_company_user_id");
		...
		if(reqPartyCompanyUserId == null || reqPartyCompanyUserId.trim().isEmpty()) {
			...
			Assert.assertEquals(editMaterialReturnResponse.getStatusCode(), 400, "Expected status code should be 400");
			String errorMessage = editMaterialReturnResponse.jsonPath().getString("message");
	...
	@Test(priority=9, dependsOnMethods="getMaterialReturnEdit")
	public void validCreatorCompanyUserId() {

		Assert.assertEquals(editMaterialReturnResponse.getStatusCode(), 200, "Expected Status Code: 200 but found: " + editMaterialReturnResponse.getStatusCode());

		String resCreatorCompanyUserId = editMaterialReturnResponse.jsonPath().getString("creator_company_user_id");
	...
	@Test(priority=10, dependsOnMethods="getMaterialReturnEdit")
	public void validProjectId() {

		String resProjectId = editMaterialReturnResponse.jsonPath().getString("project_id");
	...
	@Test(priority=11, dependsOnMethods="getMaterialReturnEdit")
	public void validInvoiceId() {

		Assert.assertEquals(editMaterialReturnResponse.getStatusCode(), 200, "Expected Status Code: 200 but found: " + editMaterialReturnResponse.getStatusCode());

		String resInvoiceId = editMaterialReturnResponse.jsonPath().getString("invoice_id");
	...
	@Test(priority=12, dependsOnMethods="getMaterialReturnEdit")
	public void validMaterial() {

		Assert.assertEquals(editMaterialReturnResponse.getStatusCode(), 200, "Expected Status Code: 200 but found: " + editMaterialReturnResponse.getStatusCode());

		List<Materials> resMaterialList = editMaterialReturnResponse.jsonPath().getList("material", Materials.class);
		...
		if(resMaterialList == null || resMaterialList.isEmpty()) {
			...
			List<String> responseMaterialIds = editMaterialReturnResponse.jsonPath().getList("material_ids");
	...
	@Test(priority=13, dependsOnMethods="getMaterialReturnEdit")
	public void validMaterialAmount() {

		this.resMaterialAmount = editMaterialReturnResponse.jsonPath().getDouble("material_amount");
	...
	@Test(priority=14, dependsOnMethods="getMaterialReturnEdit")
	public void validDiscount() {

		Assert.assertEquals(editMaterialReturnResponse.getStatusCode(), 200, "Expected Status Code: 200 but found: " + editMaterialReturnResponse.getStatusCode());

		this.resDiscount = editMaterialReturnResponse.jsonPath().getDouble("discount");
	...
	@Test(priority=15, dependsOnMethods="getMaterialReturnEdit")
	public void validGstAmount() {

		Assert.assertEquals(editMaterialReturnResponse.getStatusCode(), 200, "Expected Status Code: 200 but found: " + editMaterialReturnResponse.getStatusCode());

		this.resGstAmount = editMaterialReturnResponse.jsonPath().getDouble("gst_amount");
	...
	@Test(priority=16, dependsOnMethods="getMaterialReturnEdit")
	public void validOtherAmount() {

		Assert.assertEquals(editMaterialReturnResponse.getStatusCode(), 200, "Expected Status Code: 200 but found: " + editMaterialReturnResponse.getStatusCode());

		this.resOtherAmount = editMaterialReturnResponse.jsonPath().getDouble("other_amount");
	...
	@Test(priority=17, dependsOnMethods="getMaterialReturnEdit")
	public void validTotalPayable() {

		Double expectedReqTotalPayable = 0.0;
		Double actualResTotalPayable = 0.0;

		Double resTotalPayable = editMaterialReturnResponse.jsonPath().getDouble("total_payable");
	...
	@Test(priority=18, dependsOnMethods="getMaterialReturnEdit")
	public void validPhoto() {

		Assert.assertEquals(editMaterialReturnResponse.getStatusCode(), 200, "Expected Status Code: 200 but found: " + editMaterialReturnResponse.getStatusCode());

		List<String> resPhotoList = editMaterialReturnResponse.jsonPath().getList("photos");
	...
	@Test(priority=19, dependsOnMethods="getMaterialReturnEdit")
	public void validReturnDate() {

		String resReturnDate = editMaterialReturnResponse.jsonPath().getString("return_date");
	...
	@Test(priority=20, dependsOnMethods="getMaterialReturnEdit")
	public void validRefrenceNumber() {

		Assert.assertEquals(editMaterialReturnResponse.getStatusCode(), 200, "Expected Status Code: 200 but found: " + editMaterialReturnResponse.getStatusCode());

		String resRefrenceNumber = editMaterialReturnResponse.jsonPath().getString("vendor_reference_number");
	...
	@Test(priority=21, dependsOnMethods="getMaterialReturnEdit")
	public void validDueDays() {

		Assert.assertEquals(editMaterialReturnResponse.getStatusCode(), 200, "Expected Status Code: 200 but found: " + editMaterialReturnResponse.getStatusCode());

		Double resDueDays = editMaterialReturnResponse.jsonPath().getDouble("due_days");
