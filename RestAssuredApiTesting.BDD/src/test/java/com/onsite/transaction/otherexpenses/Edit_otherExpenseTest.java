...
public class Edit_otherExpenseTest {
	...
	public Object[][] getData() throws IOException{
		...
		String editJsonPayload = new String(Files.readAllBytes(
				Paths.get("src/test/resources/testdata_otherExpenses/edit_otherexpenses.json")));

		// REQUEST DESERIALIZATION - JSON → Request POJO
		requestPayload = mapper.readValue(editJsonPayload, OtherExpensesRequest.class);
	...
	public void createOtherExpense(OtherExpensesRequest otherRequestPayload) throws IOException {
		...
		otherExpResponse =
				...
				.when()
				.patch(OtherExpenses.editPartyEarning)
