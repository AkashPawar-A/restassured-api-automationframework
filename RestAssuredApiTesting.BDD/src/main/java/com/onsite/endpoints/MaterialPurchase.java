...
public class MaterialPurchase {
	...
	public static final String detail_materialPurchase_material = "/detail/materialpurchase-bymaterial/{id}";
	public static final String edit_materialPurchase_comment = "/edit/materialpurchase/approval/comment";
	public static final String edit_materialPurchase_approval = "/edit/materialpurchase/approval";
}
